  ...
  return (
    <div className="container-fluid p-0 vh-100">
      ...
      <div
        className="p-4"
        style={{
          marginLeft: "250px", // To avoid overlap with the Sidebar
          marginTop: "60px", // To avoid overlap with the Header
          overflowY: "auto", // Enable scrolling
          height: "calc(100vh - 60px)", // Take remaining height
        }}
      >
        <h2 className="fw-bold text-center">Weekly Quiz Performance Breakdown</h2>
        <p className="text-muted text-center">Performance breakdown across four weeks</p>
